const NINETEEN_EIGTHEEN_ALBUM = {
  ...
  songs: [
    ...
    {
      name: `"Slut!" (From The Vault)`,
      duration: "3m 0s",
      artist: "Taylor Swift",
    },
    {
      name: "Say Don't Go (From The Vault)",
      duration: "4m 39s",
      artist: "Taylor Swift",
    },
    {
      name: "Now That We Don't Talk (From The Vault)",
      duration: "2m 26s",
      artist: "Taylor Swift",
    },
    {
      name: "Suburban Legends (From The Vault)",
      duration: "3m 51s",
      artist: "Taylor Swift",
    },
    {
      name: "Is It Over Now? (From The Vault)",
      duration: "3m 49s",
      artist: "Taylor Swift",
    },
  ],
...
module.exports = NINETEEN_EIGTHEEN_ALBUM;
